...
class deathstar : public object {
    public:
        deathstar() {}
        deathstar(vec3 cen, double ra, double rb, double d) : center(cen), radiusA(ra), radiusB(rb), dis(d), axe(unit_vector(vec3(1,0.3,2))) {};
        deathstar(vec3 cen, double ra, double rb, double d, vec3 a) : center(cen), radiusA(ra), radiusB(rb), dis(d), axe(unit_vector(a)) {};
